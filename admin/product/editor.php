    ...
    <div class="col-md-12 table-responsive">
            ...
            <form method="POST" action="" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-md-9 col-12">
                        ...
                        <div class="form-group">
                            <label for="description">Nôị dung :</label>
        ...
        ?>
                            ...
                            <div class="form-group">
                                ...
                                <input name="price" required="true" type="text" class="form-control" id="price"
                                    value="<?=$price?>">
                            </div>
                            <div class="form-group">
                                <label for="discount">Discount</label>
                                <input name="discount" required="true" type="text" class="form-control" id="discount"
                                    value="<?=$discount?>">
                            </div>
